...
- В ward menu добавлена вкладка Economy для status/deposit/withdraw/upkeep/transfer.
...
8. В ward menu открыть вкладку Economy и проверить кнопки Deposit / Withdraw / Upkeep / Transfer.
