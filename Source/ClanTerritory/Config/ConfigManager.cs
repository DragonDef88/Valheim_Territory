    ...
    internal static class CtLocalization
    {
        ...
        private static Dictionary<string, string> BuildEnglishDefaults()
        {
            return new Dictionary<string, string>
            {
                ...
                { "ct.menu.diplomacy.title", "Diplomacy" },
                { "ct.menu.diplomacy.relations", "Relations" },
                { "ct.menu.diplomacy.ally", "Ally" },
                { "ct.menu.diplomacy.enemy", "Enemy" },
                { "ct.menu.diplomacy.vassal", "Vassal" },
                { "ct.menu.diplomacy.neutral", "Neutral" },
                { "ct.menu.diplomacy.target_prompt", "Target guild name" },
                { "ct.diplomacy.menu.no_relations", "No saved diplomacy relations." },
                { "ct.compat.close_current_container_first", "Close the current container first." },
                ...
                { "ct.diplomacy.command.help", "Diplomacy commands: /ctdip list, /ctdip status <guild>, /ctdip ally <guild>, /ctdip enemy <guild>, /ctdip vassal <guild>, /ctdip neutral <guild>, /ctdip set ally|enemy|vassal|neutral <guild>. Alias: /ctdiplomacy" },
                { "ct.diplomacy.command.server_only", "Diplomacy can be changed only on the server/host." },
                { "ct.diplomacy.command.no_player", "Player is not ready." },
                { "ct.diplomacy.command.no_guilds", "Guilds integration is not available." },
                { "ct.diplomacy.command.no_guild", "You are not in a Guilds guild." },
                { "ct.diplomacy.command.leader_only", "Only the guild leader can change diplomacy." },
                { "ct.diplomacy.command.set_usage", "Usage: /ctdip set ally|enemy|vassal|neutral <guild>, or /ctdip ally|enemy|vassal|neutral <guild>." },
                { "ct.diplomacy.command.status_usage", "Usage: /ctdip status <guild>." },
                { "ct.diplomacy.command.invalid_relation", "Relation must be ally, enemy, vassal, or neutral." },
                { "ct.diplomacy.command.target_required", "Target guild name is required." },
                { "ct.diplomacy.command.self_relation", "A guild cannot set diplomacy with itself." },
                { "ct.diplomacy.command.set_success", "{0} now treats {1} as {2}." },
                { "ct.diplomacy.command.status", "{0} relation to {1}: {2}." },
                { "ct.diplomacy.command.list_empty", "{0} has no saved diplomacy relations." },
                { "ct.diplomacy.command.list_header", "{0} diplomacy:" },
                { "ct.diplomacy.relation.ally", "Ally" },
                { "ct.diplomacy.relation.enemy", "Enemy" },
                { "ct.diplomacy.relation.vassal", "Vassal" },
                { "ct.diplomacy.relation.neutral", "Neutral" },
                ...
                { "ct.race.help", "Race commands: /ctrace status, /ctrace choose werewolf|vampire|odin, /ctrace reset. Alias: /ctraces" },
                { "ct.race.choose_usage", "Usage: /ctrace choose werewolf|vampire|odin" },
                { "ct.race.no_player", "Player is not ready." },
                { "ct.race.no_world", "World is not ready." },
                { "ct.race.unknown", "Unknown race. Use werewolf, vampire, or odin." },
                { "ct.race.none", "None" },
                { "ct.race.werewolf", "Werewolf" },
                { "ct.race.vampire", "Vampire" },
                { "ct.race.odin", "Odin Blessed" },
                { "ct.race.werewolf.desc", "Immune to frost. Vulnerable to spirit/silver-like damage." },
                { "ct.race.vampire.desc", "Immune to poison. Vulnerable to fire and spirit/silver-like damage." },
                { "ct.race.odin.desc", "Resistant to spirit, frost and lightning." },
                { "ct.race.status_none", "You have not chosen a race." },
                { "ct.race.status", "Race: {0}. {1}" },
                { "ct.race.chosen", "Race chosen: {0}." },
                { "ct.race.already_chosen", "Race already chosen: {0}." },
                { "ct.race.reset", "Race reset." },
        ...
        private static Dictionary<string, string> BuildRussianDefaults()
        {
            return new Dictionary<string, string>
            {
                ...
                { "ct.menu.diplomacy.title", "Дипломатия" },
                { "ct.menu.diplomacy.relations", "Отношения" },
                { "ct.menu.diplomacy.ally", "Союз" },
                { "ct.menu.diplomacy.enemy", "Враг" },
                { "ct.menu.diplomacy.vassal", "Вассал" },
                { "ct.menu.diplomacy.neutral", "Нейтрал" },
                { "ct.menu.diplomacy.target_prompt", "Имя целевой guild" },
                { "ct.diplomacy.menu.no_relations", "Нет сохранённых дипломатических отношений." },
                { "ct.compat.close_current_container_first", "Сначала закрой текущий контейнер." },
                ...
                { "ct.diplomacy.command.help", "Команды дипломатии: /ctdip list, /ctdip status <гильдия>, /ctdip ally <гильдия>, /ctdip enemy <гильдия>, /ctdip vassal <гильдия>, /ctdip neutral <гильдия>, /ctdip set ally|enemy|vassal|neutral <гильдия>. Алиас: /ctdiplomacy" },
                { "ct.diplomacy.command.server_only", "Дипломатию можно менять только на сервере/хосте." },
                { "ct.diplomacy.command.no_player", "Игрок ещё не готов." },
                { "ct.diplomacy.command.no_guilds", "Интеграция Guilds недоступна." },
                { "ct.diplomacy.command.no_guild", "Ты не состоишь в Guilds guild." },
                { "ct.diplomacy.command.leader_only", "Только лидер guild может менять дипломатию." },
                { "ct.diplomacy.command.set_usage", "Использование: /ctdip set ally|enemy|vassal|neutral <гильдия>, или /ctdip ally|enemy|vassal|neutral <гильдия>." },
                { "ct.diplomacy.command.status_usage", "Использование: /ctdip status <гильдия>." },
                { "ct.diplomacy.command.invalid_relation", "Отношение должно быть ally, enemy, vassal или neutral." },
                { "ct.diplomacy.command.target_required", "Нужно указать имя целевой guild." },
                { "ct.diplomacy.command.self_relation", "Guild не может выставить дипломатию сама с собой." },
                { "ct.diplomacy.command.set_success", "{0} теперь относится к {1} как: {2}." },
                { "ct.diplomacy.command.status", "Отношение {0} к {1}: {2}." },
                { "ct.diplomacy.command.list_empty", "У {0} нет сохранённых дипломатических отношений." },
                { "ct.diplomacy.command.list_header", "Дипломатия {0}:" },
                { "ct.diplomacy.relation.ally", "Союзник" },
                { "ct.diplomacy.relation.enemy", "Враг" },
                { "ct.diplomacy.relation.vassal", "Вассал" },
                { "ct.diplomacy.relation.neutral", "Нейтрал" },
                ...
                { "ct.race.help", "Команды рас: /ctrace status, /ctrace choose werewolf|vampire|odin, /ctrace reset. Алиас: /ctraces" },
                { "ct.race.choose_usage", "Использование: /ctrace choose werewolf|vampire|odin" },
                { "ct.race.no_player", "Игрок ещё не готов." },
                { "ct.race.no_world", "\u041C\u0438\u0440 \u0435\u0449\u0451 \u043D\u0435 \u0433\u043E\u0442\u043E\u0432." },
                { "ct.race.unknown", "Неизвестная раса. Используй werewolf, vampire или odin." },
                { "ct.race.none", "Нет" },
                { "ct.race.werewolf", "Оборотень" },
                { "ct.race.vampire", "Вампир" },
                { "ct.race.odin", "Благословлённый Одином" },
                { "ct.race.werewolf.desc", "Не боится холода. Уязвим к spirit/silver-подобному урону." },
                { "ct.race.vampire.desc", "Неуязвим к яду. Уязвим к огню и spirit/silver-подобному урону." },
                { "ct.race.odin.desc", "Устойчив к spirit, морозу и молнии." },
                { "ct.race.status_none", "Раса не выбрана." },
                { "ct.race.status", "Раса: {0}. {1}" },
                { "ct.race.chosen", "Раса выбрана: {0}." },
                { "ct.race.already_chosen", "Раса уже выбрана: {0}." },
                { "ct.race.reset", "Раса сброшена." },
