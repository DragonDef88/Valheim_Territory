    ...
    internal static class CtLocalization
    {
        ...
        private static Dictionary<string, string> BuildEnglishDefaults()
        {
            return new Dictionary<string, string>
            {
                ...
                { "ct.economy.command.help", "Economy commands: /cteco status, /cteco deposit <coins>, /cteco withdraw <coins>. Alias: /cteconomy" },
                ...
                { "ct.economy.command.status", "{0} treasury balance: {1} coins. Deposited: {2}. Withdrawn: {3}." },
        ...
        private static Dictionary<string, string> BuildRussianDefaults()
        {
            return new Dictionary<string, string>
            {
                ...
                { "ct.economy.command.help", "Команды экономики: /cteco status, /cteco deposit <монеты>, /cteco withdraw <монеты>. Алиас: /cteconomy" },
                ...
                { "ct.economy.command.status", "Баланс казны {0}: {1} монет. Внесено: {2}. Снято: {3}." },
