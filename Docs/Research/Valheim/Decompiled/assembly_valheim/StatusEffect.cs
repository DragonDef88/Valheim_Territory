...
public class StatusEffect : ScriptableObject
{
	...
	{
		return ((object)this).MemberwiseClone() as StatusEffect;
	}
	...
	protected void TriggerStartEffects()
	{
		...
		m_startEffectInstances = m_startEffects.Create(m_character.GetCenterPoint(), ((Component)m_character).transform.rotation, ((Component)m_character).transform, radius * 2f, variant);
	}

	private void RemoveStartEffects()
	{
		if (m_startEffectInstances == null || !((Object)(object)ZNetScene.instance != (Object)null))
		{
			return;
		}
	...
	public virtual void Stop()
	{
		...
		RemoveStartEffects();
		m_stopEffects.Create(((Component)m_character).transform.position, ((Component)m_character).transform.rotation);
