...
public class SEMan
{
	...
	public static readonly int s_statusEffectRested = StringExtensionMethods.GetStableHashCode("Rested");

	public static readonly int s_statusEffectEncumbered = StringExtensionMethods.GetStableHashCode("Encumbered");

	public static readonly int s_statusEffectSoftDeath = StringExtensionMethods.GetStableHashCode("SoftDeath");

	public static readonly int s_statusEffectWet = StringExtensionMethods.GetStableHashCode("Wet");

	public static readonly int s_statusEffectShelter = StringExtensionMethods.GetStableHashCode("Shelter");

	public static readonly int s_statusEffectCampFire = StringExtensionMethods.GetStableHashCode("CampFire");

	public static readonly int s_statusEffectResting = StringExtensionMethods.GetStableHashCode("Resting");

	public static readonly int s_statusEffectCold = StringExtensionMethods.GetStableHashCode("Cold");

	public static readonly int s_statusEffectFreezing = StringExtensionMethods.GetStableHashCode("Freezing");

	public static readonly int s_statusEffectBurning = StringExtensionMethods.GetStableHashCode("Burning");

	public static readonly int s_statusEffectFrost = StringExtensionMethods.GetStableHashCode("Frost");

	public static readonly int s_statusEffectLightning = StringExtensionMethods.GetStableHashCode("Lightning");

	public static readonly int s_statusEffectPoison = StringExtensionMethods.GetStableHashCode("Poison");

	public static readonly int s_statusEffectSmoked = StringExtensionMethods.GetStableHashCode("Smoked");

	public static readonly int s_statusEffectSpirit = StringExtensionMethods.GetStableHashCode("Spirit");
	...
	public StatusEffect AddStatusEffect(StatusEffect statusEffect, bool resetTime = false, int itemLevel = 0, float skillLevel = 0f)
	{
		...
		{
			Gogan.LogEvent("Game", "StatusEffect", ((Object)statusEffect).name, 0L);
		}
	...
	public void GetHUDStatusEffects(List<StatusEffect> effects)
	{
		foreach (StatusEffect statusEffect in m_statusEffects)
		{
			if (Object.op_Implicit((Object)(object)statusEffect.m_icon))
			{
