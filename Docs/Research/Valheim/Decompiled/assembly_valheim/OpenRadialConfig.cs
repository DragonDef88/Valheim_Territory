...
public class OpenRadialConfig : ScriptableObject, IRadialConfig
{
	...
	private bool TryOpenNonDefaultRadials(RadialBase radial)
	{
		...
		if ((hoverObject.TryGetComponentInParent<Catapult>(out var _) || hoverObject.TryGetComponentInParent<ShieldGenerator>(out var _) || hoverObject.TryGetComponentInParent<Chair>(out var _)) && !hoverObject.TryGetComponent<Switch>(ref @switch))
		{
			return false;
		}
		if ((Object.op_Implicit((Object)(object)hoverObject) ? hoverObject.GetComponentInParent<Interactable>() : null) == null)
		{
			return false;
		}
		if (Object.op_Implicit((Object)(object)hoverObject.GetComponentInParent<OfferingBowl>()) || Object.op_Implicit((Object)(object)hoverObject.GetComponentInParent<Fermenter>()) || Object.op_Implicit((Object)(object)hoverObject.GetComponentInParent<ItemStand>()) || Object.op_Implicit((Object)(object)hoverObject.GetComponentInParent<Catapult>()))
		{
