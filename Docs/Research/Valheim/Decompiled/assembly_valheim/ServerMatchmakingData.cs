...
public struct ServerMatchmakingData
{
	...
	public bool IsCrossplay
	{
		get
		{
			...
			Platform platformRestriction = m_platformRestriction;
			return !((Platform)(ref platformRestriction)).IsValid;
		}
	}
	...
	public bool IsUnjoinable
	{
		get
		{
			...
			return (int)PlatformManager.DistributionPlatform.PrivilegeProvider.CheckPrivilege((Privilege)1) > 0;
		}
	}
