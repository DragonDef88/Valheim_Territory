...
public abstract class KeyUI : MonoBehaviour, IPointerEnterHandler, IEventSystemHandler
{
	...
	{
		if ((Object)(object)m_lastKeyUI != (Object)(object)this && (Object)(object)EventSystem.current.currentSelectedGameObject == (Object)(object)((Component)this).gameObject && ZInput.IsGamepadActive())
		{
			OnPointerEnter(null);
		}
	}
