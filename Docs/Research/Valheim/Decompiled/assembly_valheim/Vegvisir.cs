...
public class Vegvisir : MonoBehaviour, Hoverable, Interactable
{
	...
	public bool Interact(Humanoid character, bool hold, bool alt)
	{
		...
		{
			Game.instance.DiscoverClosestLocation(location.m_locationName, ((Component)this).transform.position, location.m_pinName, (int)location.m_pinType, location.m_showMap, location.m_discoverAll);
