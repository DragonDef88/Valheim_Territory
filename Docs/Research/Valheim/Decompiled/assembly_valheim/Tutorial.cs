...
public class Tutorial : MonoBehaviour
{
	...
	{
		m_instance = this;
		((Component)m_windowRoot).gameObject.SetActive(false);
	}

	private void Update()
	{
		double timeSeconds = ZNet.instance.GetTimeSeconds();
		if (!Object.op_Implicit((Object)(object)ZoneSystem.instance) || !Object.op_Implicit((Object)(object)Player.m_localPlayer) || !(timeSeconds > m_lastGlobalKeyCheck + (double)m_GlobalKeyCheckRateSec))
		{
			return;
		}
	...
	public void ShowText(string name, bool force)
	{
		...
		{
			Debug.Log((object)("Missing tutorial text for: " + name));
		}
	}
