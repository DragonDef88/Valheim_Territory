...
public class MusicMan : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		m_instance = this;
		GameObject val = new GameObject("music");
		val.transform.SetParent(((Component)this).transform);
		m_musicSource = val.AddComponent<AudioSource>();
		...
		m_randomAmbientInterval = Random.Range(m_randomMusicIntervalMin, m_randomMusicIntervalMax);
		...
		{
			if (item2.m_enabled && item2.m_clips.Length != 0 && (Object)(object)item2.m_clips[0] != (Object)null)
			{
	...
	private void UpdateCurrentMusic(float dt)
	{
		...
		{
			if (Game.instance.InIntro() || (Object.op_Implicit((Object)(object)Player.m_localPlayer) && Player.m_localPlayer.InIntro()))
			{
				StartMusic("intro");
				return;
			}
		...
		float num = ((m_randomEventMusic == null) ? 0f : (-80f));
		m_musicOnTopDuckVolume = Mathf.MoveTowards(m_musicOnTopDuckVolume, num, 80f * Time.deltaTime);
	...
	{
		string text = null;
		text = ((!Object.op_Implicit((Object)(object)Player.m_localPlayer) || !Player.m_localPlayer.IsSafeInHome()) ? EnvMan.instance.GetAmbientMusic() : "home");
	...
	{
		if (Object.op_Implicit((Object)(object)Player.m_localPlayer) && Player.m_localPlayer.GetCurrentBiome() == Heightmap.Biome.AshLands)
		{
	...
	private bool IsSailing()
	{
		...
		if (Object.op_Implicit((Object)(object)localShip) && localShip.GetSpeed() > m_sailMusicShipSpeedThreshold)
		{
			return true;
		}
		return false;
	...
	private void UpdateMusic(float dt)
	{
		if (m_queuedMusic != null || m_stopMusic)
		{
			if (!m_musicSource.isPlaying || m_currentMusicVol <= 0f)
			{
				...
				{
					m_musicSource.clip = m_queuedMusic.m_clips[Random.Range(0, m_queuedMusic.m_clips.Length)];
		...
		if (Terminal.m_showTests)
		{
			...
			if (ZInput.GetKeyDown((KeyCode)110, true) && ZInput.GetKey((KeyCode)304, true) && (Object)(object)m_musicSource != (Object)null && m_musicSource.isPlaying)
			{
