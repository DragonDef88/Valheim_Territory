...
public struct ServerJoinData : IEquatable<ServerJoinData>
{
	...
	public ServerJoinData(ServerJoinDataSteamUser steam)
	{
		...
		m_steamUser = steam;
		m_owner = new PlatformUserID(new Platform("Steam"), m_steamUser.m_joinUserID.m_SteamID, true);
	}
	...
	public override int GetHashCode()
	{
		...
		case ServerJoinDataType.SteamUser:
			num = HashCode.Combine<int, int>(num, m_steamUser.GetHashCode());
			break;
		case ServerJoinDataType.PlayFabUser:
			num = HashCode.Combine<int, int>(num, m_playFabUser.GetHashCode());
			break;
		case ServerJoinDataType.Dedicated:
			num = HashCode.Combine<int, int>(num, m_dedicated.GetHashCode());
			break;
		}
		return num;
	}
