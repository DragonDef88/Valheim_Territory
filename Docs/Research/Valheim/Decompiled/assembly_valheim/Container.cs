...
public class Container : MonoBehaviour, Hoverable, Interactable
{
	...
	private void Awake()
	{
		...
		if (m_nview.GetZDO() != null)
		{
			...
			WearNTear wearNTear = (Object.op_Implicit((Object)(object)m_rootObjectOverride) ? ((Component)m_rootObjectOverride).GetComponent<WearNTear>() : ((Component)this).GetComponent<WearNTear>());
			...
			Destructible destructible = (Object.op_Implicit((Object)(object)m_rootObjectOverride) ? ((Component)m_rootObjectOverride).GetComponent<Destructible>() : ((Component)this).GetComponent<Destructible>());
	...
	private void DropAllItems(GameObject lootContainerPrefab)
	{
		...
		while (m_inventory.NrOfItems() > 0)
		{
			...
			Object.Instantiate<GameObject>(lootContainerPrefab, val, Random.rotation).GetComponent<Container>().GetInventory()
				.MoveAll(m_inventory);
		}
	}
	...
	private void DropAllItems()
	{
		...
		{
			Vector3 position = ((Component)this).transform.position + Vector3.up * 0.5f + Random.insideUnitSphere * 0.3f;
	...
	private void RPC_RequestOpen(long uid, long playerID)
	{
		...
		else if ((IsInUse() || (Object.op_Implicit((Object)(object)m_wagon) && m_wagon.InUse())) && uid != ZNet.GetUID())
		{
	...
	private void RPC_StackResponse(long uid, bool granted)
	{
		...
		if (granted)
		{
			...
			{
				InventoryGui.instance.m_moveItemEffects.Create(((Component)this).transform.position, Quaternion.identity);
			}
		}
		else
		{
