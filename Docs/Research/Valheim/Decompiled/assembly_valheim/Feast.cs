...
public class Feast : MonoBehaviour, Hoverable, Interactable
{
	...
	private void Start()
	{
		...
		UpdateVisual();
		if (!Object.op_Implicit((Object)(object)m_foodItem))
		{
			m_foodItem = ((Component)this).gameObject.GetComponent<ItemDrop>();
		}
		if (!Object.op_Implicit((Object)(object)m_foodItem))
		{
			ZLog.LogError((object)"Feast created without separate food item or being a food itself!");
		}
	}
	...
	public void UpdateVisual()
	{
		...
		for (int num = m_feastParts.Count - 1; num >= 0; num--)
		{
			...
			if (Object.op_Implicit((Object)(object)feastLevel.m_onAboveEquals))
			{
				feastLevel.m_onAboveEquals.SetActive(stackPercentige >= feastLevel.m_threshold);
			}
			if (Object.op_Implicit((Object)(object)feastLevel.m_onBelow))
			{
	...
	private void RPC_TryEat(long sender)
	{
		...
		int stack = GetStack();
		ZLog.Log((object)$"We eat a stack - starting with {stack}");
		if (stack > 0)
		{
			if (stack <= 1)
			{
			...
			ZLog.Log((object)$"Stack is now {GetStack()}");
	...
	{
		if (Object.op_Implicit((Object)(object)m_foodItem.m_itemData.m_shared.m_consumeStatusEffect))
		{
	...
	public void RPC_OnEat(long sender)
	{
		...
		m_eatEffect.Create(((Component)this).transform.position, ((Component)this).transform.rotation);
		UpdateVisual();
	}
	...
	public bool Interact(Humanoid human, bool hold, bool alt)
	{
		...
		if (!Object.op_Implicit((Object)(object)player) || !InUseDistance(player))
		{
			return false;
		}
		if (GetStack() <= 0)
