...
public class SaveFile
{
	...
	public readonly FileSource m_source;
	...
	public SaveFile(string path, FileSource source, SaveWithBackups parentSaveWithBackups, Action modifiedCallback)
	{
	...
	public SaveFile(string[] paths, FileSource source, SaveWithBackups parentSaveWithBackups, Action modifiedCallback)
	{
		//IL_001d: Unknown result type (might be due to invalid IL or missing references)
		//IL_001e: Unknown result type (might be due to invalid IL or missing references)
		m_paths = new List<string>();
	...
	public override int GetHashCode()
	{
		...
		return num * -1521134295 + ((object)(FileSource)(ref m_source)).GetHashCode();
	}
