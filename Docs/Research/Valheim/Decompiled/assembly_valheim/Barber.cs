...
public class Barber : MonoBehaviour, Hoverable, Interactable
{
	...
	private void Update()
	{
		if (!PlayerCustomizaton.IsBarberGuiVisible() && Object.op_Implicit((Object)(object)Player.m_localPlayer) && Object.op_Implicit((Object)(object)m_attachPoint) && (Object)(object)Player.m_localPlayer.GetAttachPoint() == (Object)(object)m_attachPoint && !InventoryGui.IsVisible() && !Minimap.IsOpen() && !Game.IsPaused())
		{
