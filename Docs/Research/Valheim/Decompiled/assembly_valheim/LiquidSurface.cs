...
public class LiquidSurface : MonoBehaviour
{
	...
	private void Awake()
	{
		m_liquid = ((Component)this).GetComponentInParent<LiquidVolume>();
	}
	...
	{
		IWaterInteractable component = ((Component)collider.attachedRigidbody).GetComponent<IWaterInteractable>();
		if (component != null)
		{
	...
	private void UpdateFloaters()
	{
		...
		for (int i = 0; i < m_inWater.Count; i++)
		{
			...
			if (Object.op_Implicit((Object)(object)transform))
			{
				...
				waterInteractable.SetLiquidLevel(surface, m_liquid.m_liquidType, (Component)(object)this);
			}
			else
			{
				s_inWaterRemoveIndices.Add(i);
	...
	private void OnTriggerExit(Collider collider)
	{
		...
		if (component != null)
		{
			...
			{
				component.SetLiquidLevel(-10000f, m_liquid.m_liquidType, (Component)(object)this);
			}
	...
	private void OnDestroy()
	{
		foreach (IWaterInteractable item in m_inWater)
		{
			...
			{
				item.SetLiquidLevel(-10000f, m_liquid.m_liquidType, (Component)(object)this);
			}
		}
		m_inWater.Clear();
	}
