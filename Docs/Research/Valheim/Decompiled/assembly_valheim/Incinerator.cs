...
public class Incinerator : MonoBehaviour
{
	...
	{
		ZLog.Log((object)("Player " + uid + " wants to incinerate " + ((Object)((Component)this).gameObject).name + "   im: " + ZDOMan.GetSessionID()));
		if (!m_nview.IsOwner())
		{
		...
		{
			((MonoBehaviour)this).StartCoroutine(Incinerate(uid));
		}
	}
	...
	private IEnumerator Incinerate(long uid)
	{
		...
		m_leverEffects.Create(((Component)this).transform.position, ((Component)this).transform.rotation);
		...
		Object.Instantiate<GameObject>(m_lightingAOEs, ((Component)this).transform.position, ((Component)this).transform.rotation);
		...
		if ((Object)(object)m_defaultResult != (Object)null && m_defaultCost > 0)
		{
		...
		{
			inventory.AddItem(((Component)item).gameObject, 1);
		}
