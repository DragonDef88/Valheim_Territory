...
public class ItemDrop : MonoBehaviour, Hoverable, Interactable
{
	...
	public class ItemData
	{
		...
		public static string GetTooltip(ItemData item, int qualityLevel, bool crafting, float worldLevel, int stackOverride = -1)
		{
			...
			if (item.m_shared.m_eitrRegenModifier > 0f && (Object)(object)player != (Object)null)
			{
			...
			if ((Object)(object)item.m_shared.m_fullAdrenalineSE != (Object)null)
			{
				m_stringBuilder.AppendFormat("\n$item_fulladrenaline: <color=orange>{0}</color>", item.m_shared.m_fullAdrenalineSE.GetTooltipString());
			}
			if (Object.op_Implicit((Object)(object)item.m_shared.m_appendToolTip) && !printConsumable(item.m_shared.m_appendToolTip.m_itemData))
			{
				return m_stringBuilder.ToString() + "\n\n" + GetTooltip(item.m_shared.m_appendToolTip.m_itemData, qualityLevel, crafting, worldLevel);
			}
			return m_stringBuilder.ToString();
			bool printConsumable(ItemData item)
			{
		...
		{
			if (Object.op_Implicit((Object)(object)m_shared.m_attackStatusEffect))
			{
			...
			if (Object.op_Implicit((Object)(object)m_shared.m_consumeStatusEffect))
			{
			...
			if (Object.op_Implicit((Object)(object)m_shared.m_equipStatusEffect))
			{
		...
		{
			if (m_shared.m_attack.m_spawnOnHitChance > 0f && (Object)(object)m_shared.m_attack.m_spawnOnHit != (Object)null)
			{
			...
			if (m_shared.m_secondaryAttack.m_spawnOnHitChance > 0f && (Object)(object)m_shared.m_secondaryAttack.m_spawnOnHit != (Object)null)
			{
			...
			{
				GameObject val = (primary ? m_shared.m_attack.m_spawnOnHit : m_shared.m_secondaryAttack.m_spawnOnHit);
		...
		{
			if (Object.op_Implicit((Object)(object)m_shared.m_setStatusEffect))
			{
		...
		{
			string text = "";
			if (Object.op_Implicit((Object)(object)m_shared.m_attack.m_attackProjectile))
			{
			...
			if (Object.op_Implicit((Object)(object)m_shared.m_spawnOnHit))
			{
	...
	private void Awake()
	{
		if (!string.IsNullOrEmpty(((Object)this).name))
		{
			m_nameHash = StringExtensionMethods.GetStableHashCode(((Object)this).name);
		}
		m_myIndex = s_instances.Count;
		s_instances.Add(this);
		string prefabName = GetPrefabName(((Object)((Component)this).gameObject).name);
		...
		if (Object.op_Implicit((Object)(object)m_nview) && m_nview.IsValid())
		{
			...
			else if (Object.op_Implicit((Object)(object)m_pieceEnableObj))
			{
				m_pieceEnableObj.SetActive(false);
			}
			((MonoBehaviour)this).InvokeRepeating("SlowUpdate", Random.Range(1f, 2f), 10f);
		}
	...
	{
		Save();
		((Component)this).gameObject.GetComponentInChildren<IEquipmentVisual>()?.Setup(m_itemData.m_variant);
	}
	...
	private void TerrainCheck()
	{
		...
		if (((Component)this).transform.position.y - groundHeight < -0.5f)
		{
	...
	private void TimedDestruction()
	{
		...
		if (!(GetTimeSinceSpawned() < 3600.0) && !IsInsideBase() && !Player.IsPlayerInRange(((Component)this).transform.position, 25f) && !InTar() && !IsPiece())
		{
			m_nview.Destroy();
		}
	}
	...
	public bool IsPiece()
	{
		if (!Object.op_Implicit((Object)(object)m_body) && Object.op_Implicit((Object)(object)m_piece))
		{
			return Object.op_Implicit((Object)(object)m_wnt);
		}
		return false;
	}
	...
	public void MakePiece(bool sendRPC = false)
	{
		...
		{
			ZLog.LogError((object)("Missing piece script to make piece out of " + ((Object)this).name));
		}
		if (Object.op_Implicit((Object)(object)m_body))
		{
			Object.Destroy((Object)(object)m_body);
			Collider componentInChildren = ((Component)this).GetComponentInChildren<Collider>();
			if (componentInChildren != null && (Object)(object)componentInChildren != (Object)null)
			{
				((Component)componentInChildren).gameObject.layer = LayerMask.NameToLayer("piece");
			}
		}
		if (Object.op_Implicit((Object)(object)m_wnt))
		{
			((Behaviour)m_wnt).enabled = true;
		}
		if (Object.op_Implicit((Object)(object)m_nview) && m_nview.IsValid())
		{
			if (m_nview.IsOwner())
		...
		if (Object.op_Implicit((Object)(object)m_pieceEnableObj))
		{
			m_pieceEnableObj.SetActive(true);
		}
		if (Object.op_Implicit((Object)(object)m_pieceDisabledObj))
		{
			m_pieceDisabledObj.SetActive(false);
		}
	}
	...
	private bool IsInsideBase()
	{
		...
		if (((Component)this).transform.position.y > 28f && Object.op_Implicit((Object)(object)EffectArea.IsPointInsideArea(((Component)this).transform.position, EffectArea.Type.PlayerBase)))
		{
			return true;
		}
		return false;
	...
	private void AutoStackItems()
	{
		...
		if (s_itemMask == 0)
		{
			s_itemMask = LayerMask.GetMask(new string[1] { "item" });
		}
		bool flag = false;
		Collider[] array = Physics.OverlapSphere(((Component)this).transform.position, 4f, s_itemMask);
		foreach (Collider val in array)
		{
			...
			if (!((Object)(object)component == (Object)null) && !((Object)(object)component == (Object)(object)this) && component.m_itemData.m_shared.m_autoStack && !((Object)(object)component.m_nview == (Object)null) && component.m_nview.IsValid() && component.m_nview.IsOwner() && !(component.m_itemData.m_shared.m_name != m_itemData.m_shared.m_name) && component.m_itemData.m_quality == m_itemData.m_quality)
			{
	...
	public void Pickup(Humanoid character)
	{
		if (m_nview.IsValid())
		{
			...
			{
				Load();
				character.Pickup(((Component)this).gameObject);
				Save();
			}
			else
			{
				m_pickupRequester = character;
				((MonoBehaviour)this).CancelInvoke("PickupUpdate");
				float num = 0.05f;
				((MonoBehaviour)this).InvokeRepeating("PickupUpdate", num, num);
				RequestOwn();
			}
		}
	}
	...
	public void RequestOwn()
	{
		if (!(Time.time - m_lastOwnerRequest < m_ownerRetryTimeout) && !m_nview.IsOwner())
		{
			...
			m_ownerRetryTimeout = Mathf.Min(0.2f * Mathf.Pow(2f, (float)m_ownerRetryCounter), 30f);
			m_ownerRetryCounter++;
	...
	public void EatUpdate()
	{
		...
		{
			((MonoBehaviour)this).CancelInvoke("EatUpdate");
			Eat();
		}
	}
	...
	public bool Eat()
	{
		if (Player.m_localPlayer.CanConsumeItem(m_itemData))
		{
			if (!CanEat())
			{
				((MonoBehaviour)this).CancelInvoke("EatUpdate");
				float num = 0.05f;
				((MonoBehaviour)this).InvokeRepeating("EatUpdate", num, num);
				RequestOwn();
				return false;
			}
			if (Object.op_Implicit((Object)(object)m_itemData.m_shared.m_consumeStatusEffect))
			{
	...
	{
		ZLog.Log((object)("Player " + uid + " wants to pickup " + ((Object)((Component)this).gameObject).name + "   im: " + ZDOMan.GetSessionID()));
		if (m_nview.IsOwner())
		{
	...
	private void PickupUpdate()
	{
		if (m_nview.IsValid())
		{
			if (CanPickup())
			{
				...
				((MonoBehaviour)this).CancelInvoke("PickupUpdate");
				Load();
				(m_pickupRequester as Player).Pickup(((Component)this).gameObject);
				Save();
			}
			else
			{
	...
	public static ItemDrop DropItem(ItemData item, int amount, Vector3 position, Quaternion rotation)
	{
		...
		ItemDrop component = Object.Instantiate<GameObject>(item.m_dropPrefab, position, rotation).GetComponent<ItemDrop>();
	...
	public void SetQuality(int quality)
	{
		...
		((Component)this).transform.localScale = m_itemData.GetScale();
	}
