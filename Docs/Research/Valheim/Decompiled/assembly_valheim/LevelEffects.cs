...
public class LevelEffects : MonoBehaviour
{
	...
	private void SetupLevelVisualization(int level)
	{
		...
		((Component)this).transform.localScale = new Vector3(levelSetup.m_scale, levelSetup.m_scale, levelSetup.m_scale);
		if (Object.op_Implicit((Object)(object)m_mainRender))
		{
			string key = Utils.GetPrefabName(((Component)m_character).gameObject) + level;
		...
		if (Object.op_Implicit((Object)(object)m_baseEnableObject))
		{
			m_baseEnableObject.SetActive(false);
		}
		if (Object.op_Implicit((Object)(object)levelSetup.m_enableObject))
		{
