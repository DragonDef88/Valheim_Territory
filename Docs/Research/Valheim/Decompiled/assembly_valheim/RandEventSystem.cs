...
public class RandEventSystem : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		...
		else if (m_randomEvent != null && Object.op_Implicit((Object)(object)Player.m_localPlayer))
		{
			if (IsInsideRandomEventArea(m_randomEvent, ((Component)Player.m_localPlayer).transform.position))
			{
	...
	private string GetForcedEvent()
	{
		if ((Object)(object)EnemyHud.instance != (Object)null)
		{
			...
			if ((Object)(object)activeBoss != (Object)null && activeBoss.m_bossEvent.Length > 0)
			{
	...
	private static void RefreshPlayerEventData()
	{
		...
		if ((int)SystemInfo.graphicsDeviceType != 4 && RetrievePlayerEventData(ZNet.instance.m_serverSyncedPlayerData, ZNet.instance.GetReferencePosition(), out var eventData))
		{
