...
public static class StringUtils
{
	...
	public static bool TryDecodeStringAsArray(string encodedString, out string[] decodedArray)
	{
		if (TryDecodeStringAsICollection<List<string>>(encodedString, out var decodedCollection))
		{
			decodedArray = decodedCollection.ToArray();
			return true;
		}
		decodedArray = null;
		return false;
	...
	public static bool ContainsString(this IReadOnlyList<string> list, string value, StringComparison comparison)
	{
