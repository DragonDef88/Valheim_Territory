...
internal class KeyValueTypeDiscriminator : ITypeDiscriminator
{
	...
	{
		if (parser.TryFindMappingEntry((Scalar scalar) => targetKey == scalar.Value, out Scalar _, out ParsingEvent value) && value is Scalar scalar2 && typeMapping.TryGetValue(scalar2.Value, out Type value2))
		{
