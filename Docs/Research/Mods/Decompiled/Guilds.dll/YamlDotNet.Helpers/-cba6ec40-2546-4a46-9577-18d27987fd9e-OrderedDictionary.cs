...
[Serializable]
internal sealed class _003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003EOrderedDictionary<TKey, TValue> : _003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003EIOrderedDictionary<TKey, TValue>, IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable where TKey : notnull
{
	private class KeyCollection : ICollection<TKey>, IEnumerable<TKey>, IEnumerable
	{
		private readonly _003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003EOrderedDictionary<TKey, TValue> orderedDictionary;
		...
		public KeyCollection(_003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003EOrderedDictionary<TKey, TValue> orderedDictionary)
		{
	...
	private class ValueCollection : ICollection<TValue>, IEnumerable<TValue>, IEnumerable
	{
		...
		public ValueCollection(_003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003EOrderedDictionary<TKey, TValue> orderedDictionary)
		{
			this.orderedDictionary = orderedDictionary;
		}
	...
	public _003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003EOrderedDictionary()
		: this((IEqualityComparer<TKey>)EqualityComparer<TKey>.Default)
	{
	}

	public _003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003EOrderedDictionary(IEqualityComparer<TKey> comparer)
	{
	...
	public bool TryGetValue(TKey key, [_003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003EMaybeNullWhen(false)] out TValue value)
	{
