...
internal static class ReflectionUtility
{
	public static Type? GetImplementedGenericInterface(Type type, Type genericInterfaceType)
	{
		...
		{
			if (ReflectionExtensions.IsGenericType(implementedInterface) && implementedInterface.GetGenericTypeDefinition() == genericInterfaceType)
			{
	...
	{
		if (ReflectionExtensions.IsInterface(type))
		{
			yield return type;
		}
