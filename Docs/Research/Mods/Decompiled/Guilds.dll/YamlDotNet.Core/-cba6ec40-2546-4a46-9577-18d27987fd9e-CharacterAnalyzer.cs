...
[DebuggerStepThrough]
internal readonly struct _003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003ECharacterAnalyzer<TBuffer> where TBuffer : _003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003EILookAheadBuffer
{
	public TBuffer Buffer { get; }

	public bool EndOfInput => Buffer.EndOfInput;

	public _003Ccba6ec40_002D2546_002D4a46_002D9577_002D18d27987fd9e_003ECharacterAnalyzer(TBuffer buffer)
	{
		if (buffer == null)
		{
	...
	{
		char c = Buffer.Peek(offset);
		return Polyfills.Contains(expectedCharacters, c);
	}
}
